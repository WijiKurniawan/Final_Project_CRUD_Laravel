...
<div class="container">
    ...
    <form action="/pegawai/{{$pegawai->id}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="NamaPerusahaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$pegawai->NamaPerusahaan}}">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Tahun</label>
            <input type="text" name="Tahun" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$pegawai->Tahun}}">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Jabatan Lama</label>
            <input type="date" name="Jabatan Lama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$pegawai->Jabatan Lama}}">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Lama Bekerja</label>
            <input type="text" name="Lama Bekerja" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$pegawai->Lama Bekerja}}">
        </div>
